...
# STAGES = ('E-711.C82',)  # connect stages to axes
...
def main():
    ...
    with GCSDevice(CONTROLLERNAME) as pidevice:
        ...
        pidevice.ConnectTCPIP(ipaddress='172.16.0.35')
        ...
        for i in range(20):
            ...
            # for item in ranges:
            #     print('haha',uniform(item[0], item[1]))
            ...
            pidevice.MOV(pidevice.axes[0], targets[0])
